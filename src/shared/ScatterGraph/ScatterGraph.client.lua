...
local Vector3Node = require(script.Parent.Nodes:WaitForChild("Vector3Node"))
local RotationNode = require(script.Parent.Nodes:WaitForChild("RotationNode"))
local SetRotationRangeNode = require(script.Parent.Nodes:WaitForChild("SetRotationRangeNode"))
...
local nodeRegistry = {
	...
	SetRotationRange = SetRotationRangeNode,
	SetScaleRange = SetScaleRangeNode,
	SetTranslationOffsetRange = SetTranslationOffsetRangeNode,
	Reroute = RerouteNode,
